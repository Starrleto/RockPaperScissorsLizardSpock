...
submitButton.addEventListener('click', function(e){
    if(turn == 2){
        announce.innerText = "Player One, Choose your play!"
        displayResult(checkWin());
    }
    else{
        announce.innerText = "Player Two, Choose your play!"
        resetButtons();
        turn++;
    }
});
...
resultOpen.addEventListener('click', function(e){
    if(pwins > oppwins)
    resultHeader.innerText = "Player One Won the game!";
    else
    resultHeader.innerText = "Player Two Won the game!";
...
function displayResult(result){
        ...
        switch(result){
            ...
            break;
            case "pwin": 
                displayer.innerText = "Player One Wins this round!";
                displayerScore.innerText = `${pwins} - ${oppwins}`;
            break;
            case "plose": 
                displayer.innerText = "Player Two Wins this round!";
                displayerScore.innerText = `${pwins} - ${oppwins}`;
            break;
        }
}
